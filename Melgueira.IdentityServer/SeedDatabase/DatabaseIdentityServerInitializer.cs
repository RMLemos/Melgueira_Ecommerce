using IdentityModel;
using Melgueira.IdentityServer.Configuration;
using Melgueira.IdentityServer.Data;
using Microsoft.AspNetCore.Identity;
using System.Security.Claims;

namespace Melgueira.IdentityServer.SeedDatabase;
...
public class DatabaseIdentityServerInitializer : IDatabaseSeedInitializer
{
    ...
    public void InitializeSeedDatabase()
    {
        ...
        if (_roleManager.FindByNameAsync(IdentityConfiguration.Admin).Result == null)
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                UserName = "melgueira-admin",
                NormalizedUserName = "MELGUEIRA-ADMIN",
                Email = "melgueira_admin@com.br",
                NormalizedEmail = "MELGUEIRA_ADMIN@COM.BR",
                EmailConfirmed = true,
                LockoutEnabled = false,
                PhoneNumber = "+351 961234567",
                FirstName = "Melgueira",
        ...
        if (_roleManager.FindByNameAsync(IdentityConfiguration.Client).Result == null)
        {
            ...
            ApplicationUser client = new ApplicationUser()
            {
                UserName = "melgueira-client",
                NormalizedUserName = "MELGUEIRA-CLIENT",
                Email = "melgueira_client@com.br",
                NormalizedEmail = "MELGUEIRA_CLIENT@COM.BR",
                EmailConfirmed = true,
                LockoutEnabled = false,
                PhoneNumber = "+351 961234567",
                FirstName = "Melgueira",
