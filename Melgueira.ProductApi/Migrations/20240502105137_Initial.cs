    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "CategoryName", "CreatedAt", "LastUpdatedAt" },
                values: new object[,]
                {
                    { 1, "Honey", new DateTime(2024, 5, 2, 11, 51, 36, 736, DateTimeKind.Local).AddTicks(3519), null },
                    { 2, "Beverage", new DateTime(2024, 5, 2, 11, 51, 36, 736, DateTimeKind.Local).AddTicks(3576), null }
                });
